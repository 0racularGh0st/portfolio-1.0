        ...
        <li>
          <a href="javascript:;" v-on:click="smoothScroll('.about-main-section',1500)"
            ><svg width="23" height="23" fill="url(#grad1)">
              ...
              ></path></svg
            ><span >About Me <span class="hightlight-text-underline"></span></span></a
          >
        </li>
        <li>
          <a href="javascript:;"
            ><svg width="23" height="23" fill="url(#grad1)">
              ...
              ></path></svg
            ><span >Skills<span class="hightlight-text-underline"></span></span></a
          >
        </li>
         <li>
          <a href="javascript:;"
            ><svg width="23" height="23" fill="url(#grad1)">
              ...
              ></path></svg
            ><span >Projects<span class="hightlight-text-underline"></span></span></a
          >
        </li>
      </ul>
      <div class="burger">
