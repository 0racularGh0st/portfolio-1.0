...
<div class="outer-social-container">
    ...
    <div class="social-container">
        <div class="vertical-line1 show-vertical-line"/>
        <div class="github" >
        ...
        <div class="linkedin" aria-label="Linkedin">
        ...
        <div class="vertical-line2 show-vertical-line"/>
    </div>
    </div>
</template>
<script>
...
@media (min-width: 769px){
        ...
        .vertical-line2{
            background: linear-gradient(135deg, rgb(62, 110, 173) 0%,rgb(106, 228, 230) 50%, transparent 100%);
            height: 100%;
            width: 1.5px;
            transition: opacity 0.3s ease;
            opacity: 0;
        ...
        .show-vertical-line{
             animation: 0.3s ease 0.3s 1 normal forwards running showLine;
        }
        @keyframes showLine {
                0%{
                    opacity: 0;
        ...
        .github{
            ...
            animation: 0.5s ease 0.3s 1 normal forwards running show-social-icon;
        }
        .linkedin{
            margin-bottom: 8px;
             transform: translate3d(-50px,0px,0px);
            animation: 0.5s ease 0.44s 1 normal forwards running show-social-icon;
        }
        .email{
             transform: translate3d(-50px,0px,0px);
            animation: 0.5s ease 0.58s 1 normal forwards running show-social-icon;
        }
